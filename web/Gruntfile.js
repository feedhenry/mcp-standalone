  ...
  grunt.initConfig({
    ...
    usemin: {
      ...
      options: {
        ...
        // blockReplacements: {
        //   js: function (block) {
        //     var originalRevvedDest = grunt.filerev.summary[appConfig.dist + '/' + block.dest];
        //     var customDest = block.dest
        //     if (originalRevvedDest) {
        //       customDest = originalRevvedDest.replace(appConfig.dist, '/static');
        //     } else {
        //       customDest = "/static/" + block.dest;
        //     }
